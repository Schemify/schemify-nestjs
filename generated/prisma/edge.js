...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\develop\\3-personal\\schemify\\schemify-nestjs\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\develop\\3-personal\\schemify\\schemify-nestjs\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"sqlite\"\n  url      = env(\"DATABASE_URL\")\n}\n\n// Define el modelo de ExampleEntity\nmodel Example {\n  id          String   @id @default(uuid())\n  name        String\n  description String?\n  createdAt   DateTime @default(now())\n  updatedAt   DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "d031827eebfd06458272073287b94bdf721984bf5a3cfda3fc35197b8c82da12",
  "copyEngine": true
}
config.dirname = '/'
